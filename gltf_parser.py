...
json_file = open("RightControlPointScale0.1.gltf")
...
json_file = open("RightControlPointScale1.0.gltf")
json_str = json_file.read()
json_data = json.loads(json_str)
buffer_str = json_data['buffers'][0]['uri']
real_buffer_index = buffer_str.find('base64') + len('base64') + 1
...
byte_lengths = [288, 288, 192, 72, 12, 108]
...
if(len(not_equal) > 0):
    ...
    print("Error no values were changed even thought the right control point was scaled by 0.1.")
